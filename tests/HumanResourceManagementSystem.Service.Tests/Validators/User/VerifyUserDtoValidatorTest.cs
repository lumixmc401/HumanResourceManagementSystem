...
namespace HumanResourceManagementSystem.Service.Tests.Validators.User
{
    [TestFixture]
    public class VerifyUserDtoValidatorTest
    {
        private VerifyUserDtoValidator _validator;

        [SetUp]
        public void Setup()
        {
            _validator = new VerifyUserDtoValidator();
        }
        ...
        {
            // Arrange
            var dto = new VerifyUserDto { Email = email, Password = "validPassword123" };
        ...
        public async Task ValidateEmail_WhenTooLong_ShouldHaveValidationError()
        {
            ...
            var dto = new VerifyUserDto { Email = longEmail, Password = "validPassword123" };
        ...
        {
            // Arrange
            var dto = new VerifyUserDto { Email = "test@example.com", Password = "" };
        ...
        {
            // Arrange
            var dto = new VerifyUserDto { Email = "test@example.com", Password = "123" };
        ...
        public async Task ValidatePassword_WhenTooLong_ShouldHaveValidationError()
        {
            ...
            var dto = new VerifyUserDto { Email = "test@example.com", Password = longPassword };
        ...
        {
            // Arrange
            var dto = new VerifyUserDto { Email = "test@example.com", Password = password };
